...
- `20260803_0010h`: append-only reviewed-root rebind after fixing zero-provider binding evidence and DB-owned authorization handoff, with no source mutation;

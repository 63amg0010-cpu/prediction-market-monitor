...
| Required cadence budget | Eight three-hour collector slots per day at a 6-minute timeout consume at most **1,488 minutes per 31-day month**. Ninety-six independent verifier slots per day at a 3-minute timeout add **8,928 minutes**, for **10,416 minutes total**. | This does not fit the 2,000-minute private GitHub Free allowance. `.github/workflows/verify.yml` therefore skips private scheduled jobs. Public standard runners are the approved free path; there is no paid fallback. |

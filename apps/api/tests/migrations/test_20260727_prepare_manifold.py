...
def test_0011_follows_0010g_without_branching() -> None:
    ...
    assert revision.down_revision == "20260803_0010g"
...
def test_0011_renders_append_only_activation_schema_and_inert_source() -> None:
    ...
    command.upgrade(config, "20260803_0010g:20260727_0011", sql=True)
    ddl = output.getvalue()
...
def test_0011_offline_downgrade_is_inert_and_retains_evidence() -> None:
    ...
    command.downgrade(config, "20260727_0011:20260803_0010g", sql=True)
    ddl = output.getvalue()
